...
const AddProduct = () => {
    ...
    const onSubmitHandler = async (event) => {
        try {
            ...
            //using this productdata we will create form data which will be send on the api request
                        ...
                        {Array(4).fill('').map((_, index) => (
                            <label key={index} htmlFor={`image${index}`}>
                                ...
                                <input onChange={(e)=>{
                                    ...
                                    setFiles(updatedFiles);  /* uploaded files are saved in the files state */
                                }}
